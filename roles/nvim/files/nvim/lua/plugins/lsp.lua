...
return {
  -- mason.nvim — LSP/DAP/linter/formatter installer
  {
    ...
    build = ":MasonUpdate",  -- Update mason's registry on install/update
    config = function()
      require("mason").setup({
        ui = {
          border = "rounded",
  ...
  -- mason-lspconfig — Auto-install and configure LSP servers
  {
    ...
    config = function()
      require("mason-lspconfig").setup({
        -- Servers to install automatically via Mason.
      ...
      -- We'll enhance these with nvim-cmp's completion capabilities in cmp.lua.
      local capabilities = vim.lsp.protocol.make_client_capabilities()
      -- If nvim-cmp is available, merge its capabilities
